...
DEFAULT_EXPERIMENT_NAME = 'nyc-taxi-experiment-hw3'
DEFAULT_TRACKING_URI = 'http://mlflow:5000/'
mlflow.set_tracking_uri(uri=DEFAULT_TRACKING_URI)
...
def track_experiment(
    ...
    vectorizer: Optional[DictVectorizer] = None,
    ...
    **kwargs,
    ...
    if vectorizer:
        ...
        client.log_artifact(run_id, vectorizer_path)
        if verbosity:
            print(f'Logged DictVectorizer at {vectorizer_path}.')
